...
'''
API HTTP method
string responseHttpMethod ""
'''
responseHttpMethod = 'post'
...
def signature_genarator(requestBody, absApiUrl, responseHttpMethod, clientSecret):

    httpmethod = str(responseHttpMethod).upper()
...
'''
signature = signature_genarator(responseBody, absApiUrl, responseHttpMethod, clientSecret)
